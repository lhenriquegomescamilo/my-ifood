...
./mvnw package
```
It produces the `order-0.0.1-SNAPSHOT-runner.jar` file in the `/target` directory.
...
The application is now runnable using `java -jar target/order-0.0.1-SNAPSHOT-runner.jar`.
